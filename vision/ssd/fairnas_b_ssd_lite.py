...
from ..nn.FairNAS_B import FairNasB, InvertedResidual
...
def create_fairnas_b_ssd_lite(num_classes, is_test=False):
...
def create_fairnas_b_ssd_lite_predictor(net, candidate_size=200, nms_method=None, sigma=0.5, device=torch.device('cpu'), nms_gpu=False):
